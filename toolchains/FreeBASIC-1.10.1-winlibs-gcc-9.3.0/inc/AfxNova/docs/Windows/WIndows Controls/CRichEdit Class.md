...
The `CRichEdit` static class provides methods for all the rich edit Windows messages. It includes a table with method names and their descriptions, followed by detailed explanations of each method, including their parameters, return values, and usage examples. The methods cover a wide range of functionalities such as URL detection, autocorrect, clipboard operations, undo/redo actions, character formatting, and various other features and settings for rich edit controls.

| Name       | Description |
| ---------- | ----------- |
| [AutoUrlDetect](#autourldetect) | Enables or disables automatic detection of URLs by a rich edit control. |
| [CallAutocorrectProc](#callautocorrectproc) | Calls the application-defined autocorrect callback procedure. |
| [CanPaste](#canpaste) | Determines whether a rich edit control can paste a specified clipboard format. |
| [CanRedo](#canredo) | Determines whether there are any actions in the rich edit control redo queue. |
| [CanUndo](#canundo) | Determines whether there are any actions in the rich edit control undo queue. |
| [CharFromPos](#charfrompos) | Retrieves information about the character closest to a specified point in the client area of a rich edit control. |
...
| [ExGetSel](#exgetdel) | Retrieves the starting and ending character positions of the selection in a rich edit control. |
...
| [GetAutoCorrectProc](#getautovorrectproc) | Gets a pointer to the application-defined **AutoCorrectProc** callback function. |
| [GetAutoUrlDetect](#getautourldetect) | Indicates whether the auto URL detection is turned on in the rich edit control. |
| [GetBidiOptions](#getbidioptions) | Indicates the current state of the bidirectional options in the rich edit control. |
| [GetCharFormat](#getcharformat) | Determines the current character formatting in a rich edit control. |
| [GetCTFModeBias](#getctfmodebias) | Retrieves the Text Services Framework mode bias values for a Microsoft Rich Edit control. |
| [GetCTFOpenStatus](#getctfopenstatus) | Determines if the Text Services Framework (TSF) keyboard is open or closed. |
| [GetEditStyle](#geteditstyle) | Retrieves the current edit style flags. |
| [GetEditStyleEx](#geteditstyleex) | Retrieves the current extended edit style flags. |
| [GetEllipsisMode](#getellipsismode) | Retrieves the current ellipsis mode. |
| [GetEllipsisState](#getellipsisstate) | Retrieves the current ellipsis state. |
| [GetEventMask](#geteventmask) | Retrieves the event mask for a rich edit control. The event mask specifies which notification messages the control sends to its parent window. |
| [GetFirstVisibleLine](#getfirstvisibleline) | Retrieves the zero-based index of the uppermost visible line in a multiline rich edit control. |
| [GetHyphenateInfo](#gethyphenateinfo) | Retrieves information about hyphenation for a Microsoft Rich Edit control. |
| [GetIMEColor](#getimecolor) | Retrieves the Input Method Editor (IME) composition color. This message is available only in Asian-language versions of the operating system. |
| [GetIMECompMode](#getimecompMode) | Retrieves the current IME mode for a rich edit control. |
| [GetIMECompText](#getimecomptext) | Retrieves the Input Method Editor (IME) composition text. |
| [GetIMEModeBias](#getimemodebias) | Retrieves the Input Method Editor (IME) mode bias for a Microsoft Rich Edit control. |
| [GetIMEOptions](#getimeoptions) | Retrieves the current Input Method Editor (IME) options. This message is available only in Asian-language versions of the operating system. |
| [GetIMEProperty](#getimeproperty) | Retrieves the property and capabilities of the Input Method Editor (IME) associated with the current input locale. |
| [GetLangOptions](#richEdit_getlangoptions) | Retrieves a rich edit control's option settings for Input Method Editor (IME) and Asian language support. |
| [GetLimitText](#getlimittext) | Retrieves the current text limit for a rich edit control. |
| [GetLine](#getline) | Copies a line of text from a rich edit control. |
| [GetLineCount](#getlinecount) | Retrieves the number of lines in a multiline rich edit control. |
| [GetModify](#getmodify) | Retrieves the state of a rich edit control's modification flag. The flag indicates whether the contents of the rich edit control have been modified. |
...
| [GetOptions](#getoptions) | Retrieves rich edit control options. |
| [GetPageRotate](#getpagerotate) | Deprecated. Retrieves the text layout for a Microsoft Rich Edit control. |
| [GetParaFormat](#getparaformat) | Retrieves the paragraph formatting of the current selection in a rich edit control. |
| [GetPasswordChar](#getpasswordchar) | Retrieves the password character that a rich edit control displays when the user enters text. |
| [GetPunctuation](#getpunctuation) | Retrieves the current punctuation characters for the rich edit control. |
| [GetRect](#getrect) | Retrieves the formatting rectangle of a rich edit control. |
| [GetRedoName](#getredoname) | Retrieves the type of the next action, if any, in the control's redo queue. |
| [GetScrollPos](#getscrollpos) | Obtains the current scroll position of the edit control. |
| [GetSel](#getsel) | Retrieves the starting and ending character positions of the current selection in a rich edit control. |
...
| [GetText](#gettext) | Retrieves the text from a rich edit control. |
| [GetTextEx](#gettextex) | Retrieves all of the text from the rich edit control in any particular code base you want. |
...
| [GetTextMode](#gettextmode) | Retrieves the current text mode and undo level of a rich edit control. |
| [GetTextRange](#gettextrange) | Retrieves a specified range of characters from a rich edit control. |
| [GetThumb](#getthumb) | Retrieves the position of the scroll box (thumb) in the vertical scroll bar of a multiline rich edit control. |
| [GetTouchOptions](#gettouchoptions) | Retrieves the touch options that are associated with a rich edit control. |
| [GetTypographyOptions](#gettypographyoptions) | Returns the current state of the typography options of a rich edit control. |
| [GetUndoName](#getundoname) | Retrieves the type of the next undo action, if any. |
| [GetWordBreakProc](#getwordbreakproc) | Retrieves the address of the current Wordwrap function. |
| [GetWordBreakProcEx](#getwordbreakprocex) | Retrieves the address of the currently registered extended word-break procedure. |
| [GetWordWrapMode](#getwordwrapmode) | Retrieves the current word wrap and word-break options for the rich edit control. |
| [GetZoom](#getzoom) | Retrieves the current zoom ratio, which is always between 1/64 and 64. |
...
| [LimitText](#limittext) | Sets the text limit of a rich edit control. The text limit is the maximum amount of text, in characters, that the user can type into the edit control. |
| [LineFromChar](#linefromchar) | Retrieves the index of the line that contains the specified character index in a multiline rich edit control. |
| [LineIndex](#lineindex) | Retrieves the character index of the first character of a specified line in a multiline rich edit control. |
...
| [SetAutocorrectProc](#setautocorrectproc) | Sets a pointer to the application-defined **AutoCorrectProc** callback procedure. |
...
| [SetCharFormat](#setcharformat) | Sets character formatting in a rich edit control. |
| [SetCTFModeBias](#setctfmodebias) | Sets the Text Services Framework (TSF) mode bias for a Microsoft Rich Edit control. |
| [SetCTFOpenStatus](#setctfopenstatus) | Opens or closes the Text Services Framework (TSF) keyboard. |
| [SetEditStyle](#seteditstyle) | Sets the current edit style flags. |
| [SetEditStyleEx](#seteditstyleex) | Sets the current edit style flags for a rich edit control. |
| [SetEllipsisMode](#setellipsismode) | Sets the current ellipsis mode for a rich edit control. |
...
| [SetHyphenateInfo](#sethyphenateinfo) | Sets the way a Microsoft Rich Edit control does hyphenation. |
...
| [SetIMEOptions](#setimeoptions) | Sets the Input Method Editor (IME) options. |
| [SetLangOptions](#setlangoptions) | Sets options for Input Method Editor (IME) and Asian language support in a rich edit control. |
| [SetLimitText](#setlimittext) | Sets the text limit of a rich edit control. The text limit is the maximum amount of text, in characters, that the user can type into the edit control. |
...
| [SetModify](#setmodify) | Sets or clears the modification flag for a rich edit control. The modification flag indicates whether the text within the rich edit control has been modified. |
...
| [SetPalette](#SetPalette) | Deprecated. Sets the text layout for a Microsoft Rich Edit control. |
| [SetParaFormat](#setparaformat) | Sets the paragraph formatting for the current selection in a rich edit control. |
| [SetPasswordChar](#setpasswordchar) | Sets or removes the password character for a rich edit control. When a password character is set, that character is displayed in place of the characters typed by the user. |
| [SetPunctuation](#setpunctuation) | Sets the punctuation characters for a rich edit control. |
| [SetReadOnly](#setreadonly) | Sets or removes the read-only style (ES_READONLY) of a rich edit control. |
| [SetRect](#setrect) | Sets the formatting rectangle of a multiline rich edit control. |
| [SetRectNP](#setrectnp) | Sets the formatting rectangle of a multiline rich edit control. |
| [SetScrollPos](#setscrollpos) | Tells the rich edit control to scroll to a particular point. |
| [SetSel](#setsel) | Selects a range of characters in a rich edit control. |
| [SetStoryType](#setstorytype) | Sets the story type. |
| [SetTableParams](#settablearams) | Changes the parameters of rows in a table. |
...
| [SetTextMode](#settextmode) | Sets the text mode or undo level of a rich edit control. |
| [SetTouchOptions](#settouchoptions) | Sets the touch options associated with a rich edit control. |
| [SetTypographyOptions](#settypographyoptions) | Sets the text mode or undo level of a rich edit control. |
| [SetUIAName](#setuiamame) | Sets the name of a rich edit control for UI Automation (UIA). |
...
| [SetWordBreakProcEx](#setwordnreakprocex) | Sets the extended word-break procedure. |
...
```
FUNCTION AutoUrlDetect (BYVAL hRichEdit AS HWND, BYVAL fUrlDetect AS LONG) AS LONG
```
...
```
FUNCTION FindText (BYVAL hRichEdit AS HWND, BYVAL fOptions AS DWORD, BYVAL lpft AS FINDTEXTW PTR) AS LONG
```
| Parameter  | Description |
| ---------- | ----------- |
| *hRichEdit* | The handle of the rich edit control. |
...
**FindTextEx** uses the [FINDTEXTEXW](https://learn.microsoft.com/en-us/windows/win32/api/richedit/ns-richedit-findtextexw) structure, while **FindText** uses the [FINDTEXTW](https://learn.microsoft.com/en-us/windows/win32/api/richedit/ns-richedit-findtextw) structure. The difference is that EM_FINDTEXTEXW reports the range of text that was found.
...
```
FUNCTION FindWordBreak (BYVAL hRichEdit AS HWND, BYVAL fOperation AS DWORD, BYVAL dwStartPos AS DWORD) AS DWORD
...
```
SUB GetBidiOptions (BYVAL hRichEdit AS HWND, BYVAL lpbo AS BIDIOPTIONS PTR)
...
```
FUNCTION GetCTFModeBias (BYVAL hRichEdit AS HWND) AS LONG
...
| **SES_EX_NOMATH** | Disable insertion of math zones (default: 1). To enable math editing and display, send the **SetEditStyleEx** message with *fStyle* set to 0, and *fMask* set to SES_EX_NOMATH. |
| **SES_EX_NOTABLE** | Disable insertion of tables. The **InsertTable** message returns **E_FAIL** and RTF tables are skipped (default: 0). |
...
| ---------- | ----------- |
| *hRichEdit* | The handle of the rich edit control. |
| *lppt* | Pointer to a [POINT](https://learn.microsoft.com/en-us/windows/win32/api/windef/ns-windef-point) structure. After calling **GetScrollPos**, this parameters contains a point in the virtual text space of the document, expressed in pixels. This point will be the point that is currently located in the upper-left corner of the edit control window. |
...
```
FUNCTION GetTableParams (BYVAL hRichEdit AS HWND, BYVAL lptp AS TABLEROWPARMS PTR, _
...
| Return code  | Description |
| ------------ | ----------- |
| **E_FAIL** | Changes cannot be made. This can occur if the control is a plain-text or single-line control, or if the insertion point is inside a math object. It also occurs if tables are disabled if the **SetEditStyleEx** message sets the **SES_EX_NOTABLE** value. |
...
| *buffer* | Pointer to the buffer to receive the text. The size of this buffer, in bytes, is specified by the *cb* member of the [GETTEXTEX](https://learn.microsoft.com/en-us/windows/win32/api/richedit/ns-richedit-gettextex) structure. Use the **GetTextLength** message to get the required size of the buffer. |
...
| **TM_MULTILEVELUNDO** |   8   | The control supports multiple undo actions. This is the default setting. Use the *SetUndoLimit* message to set the maximum number of undo actions. |
...
```
FUNCTION GetUndoName (BYVAL hRichEdit AS HWND) AS DWORD
```
...
```
FUNCTION GetWordBreakProcEx (BYVAL hRichEdit AS HWND) AS LONG_PTR
```
...
| ---------- | ----------- |
| *hRichEdit* | The handle of the rich edit control. |
| *lpip* | A pointer to a [RICHEDIT_IMAGE_PARAMETERS](https://learn.microsoft.com/en-us/windows/win32/api/richedit/ns-richedit-image_parameters) structure that contains the image blob. |
...
```
FUNCTION InsertTable (BYVAL hRichEdit AS HWND, BYVAL lptp AS TABLEROWPARMS PTR, _
   BYVAL lptcp AS TABLECELLPARMS PTR) AS DWORD
```
| Parameter  | Description |
| ---------- | ----------- |
...
```
SUB LimitText (BYVAL hRichEdit AS HWND, BYVAL chMax AS DWORD)
```
...
The **LimitText** message limits only the text the user can enter. It does not affect any text already in the edit control when the message is sent, nor does it affect the length of the text copied to the edit control by the **SetText** message. If an application uses the **SetTExt** message to place more text into an edit control than is specified in the **LimitText** message, the user can edit the entire contents of the edit control.

#### Note

**LimitText** ad **SetLimitText** are the same message.
...
```
SUB PasteSpecial (BYVAL hRichEdit AS HWND, BYVAL clpfmt AS DWORD, BYVAL lprps AS REPASTESPECIAL PTR)
...
```
FUNCTION SetFontSize (BYVAL hRichEdit AS HWND, BYVAL ptsize AS LONG) AS LONG
```
...
```
SUB SetPasswordChar (BYVAL hRichEdit AS HWND, BYVAL dwchar AS DWORD)
```
...
```
SUB SetRect (BYVAL hRichEdit AS HWND, BYVAL fCoord AS LONG, BYVAL prect AS RECT PTR)
```
...
```
SUB SetSel (BYVAL hRichEdit AS HWND, BYVAL nStart AS LONG, BYVAL nEnd AS LONG)
```
...
```
FUNCTION SetTableParams (BYVAL hRichEdit AS HWND, BYVAL lptp AS TABLEROWPARMS PTR, _
   BYVAL lptcp AS TABLECELLPARMS PTR) AS DWORD
```
...
```
FUNCTION SetTabStops (BYVAL hRichEdit AS HWND, BYVAL nTabs AS LONG, BYVAL rgTabStops AS LONG_PTR) AS LONG
```
...
```
FUNCTION SetTextExW (BYVAL hRichEdit AS HWND, BYVAL pstex AS SETTEXTEX PTR, BYVAL pwszText AS WSTRING PTR) AS DWORD
```
...
| **TM_MULTILEVELUNDO** | The control supports multiple undo operations. This is the default setting. Use the **SetUndoLimit** message to set the maximum number of undo actions. |
...
| **RTO_DISABLEHANDLES** | Enable or disable the touch gripper handles, depending on the value of *Options*. When handles are disabled, they are hidden if they are visible and remain hidden until an **SetTouchOptions** message changes their status. |
...
```
SUB SetWordBreakProc (BYVAL hRichEdit AS HWND, BYVAL pfn AS LONG_PTR)
```
...
```
FUNCTION StopGroupTyping (BYVAL hRichEdit AS HWND) AS DWORD
```
...
You can send the **StopGroupTyping** message to break consecutive typing actions into smaller undo groups. For example, you could send **StopGroupTyping** after each character or at each word break.
...
```
FUNCTION LoadRtfFromResourceW (BYVAL hRichEdit AS HWND, BYVAL hInstance AS HINSTANCE, _
